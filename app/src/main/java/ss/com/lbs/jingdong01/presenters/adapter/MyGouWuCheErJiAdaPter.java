...
public class MyGouWuCheErJiAdaPter extends BaseExpandableListAdapter {
    private Context context;
    private List<GouWuChechaBean.DataBean> data;
    private OnView iview;

    public MyGouWuCheErJiAdaPter(Context context,List<GouWuChechaBean.DataBean> data, OnView iview) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView = View.inflate(context, R.layout.mygouwuche_item1, null);
        ...
        mypresenthodler.prenter_cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GouWuChechaBean.DataBean dataBean = data.get(groupPosition);
                boolean isCheked  = dataBean.isPresenterck();
                isCheked=!isCheked;
                dataBean.setPresenterck(isCheked);
                List<GouWuChechaBean.DataBean.ListBean> list = MyGouWuCheErJiAdaPter.this.data.get(groupPosition).getList();
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView = View.inflate(context, R.layout.mygouwuche_item2, null);
        ...
        final GouWuChechaBean.DataBean.ListBean mybean = data.get(groupPosition).getList().get(childPosition);
        ...
        mychildhodler.child_ck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyGouWuCheErJiAdaPter.this.data.get(groupPosition).setPresenterck(flag);
                iview.heji();
                notifyDataSetChanged();
            }
        });
